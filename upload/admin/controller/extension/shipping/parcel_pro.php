...
class ControllerExtensionShippingParcelPro extends Controller {
    ...
    public function index() {
        ...
        $options = array();
        $instance = new Parcelpro($this->registry);
        ...
        $data['action'] = $this->url->link('extension/shipping/parcel_pro', 'user_token=' . $this->session->data['user_token'], 'SSL');
        ...
        foreach ($languages as $language) {
            if (isset($this->request->post['shipping_parcel_pro_heading'][$language['code']])) {
                $data['shipping_parcel_pro_heading'][$language['code']] = $this->request->post['shipping_parcel_pro_heading_'.$language['code']];
            } else {
                $data['shipping_parcel_pro_heading'][$language['code']] = $this->config->get('shipping_parcel_pro_heading')[$language['code']];
            }
        }
        ...
        $this->response->setOutput($this->load->view('extension/shipping/parcelpro', $data));
    }
